...
public interface ObjectDAO {
    ...
    boolean newObject(String name,String uri,String bucketUri, byte[] content, int contentLength,String contentType,Date lastModified, Date createdDate,String hash);
